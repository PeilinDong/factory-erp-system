...
final class SupplierService
{
    ...
    {
        return $this->suppliers->search(trim($query));
    }
    ...
    {
        return $this->suppliers->create($this->normalize($data));
    }
    ...
    public function update(int $id, array $data): array
    {
        ...
        return $this->suppliers->update($id, $this->normalize($data));
    }
    ...
    public function setActive(int $id, bool $active): array
    {
        ...
        return $this->suppliers->setActive($id, $active);
    }
    ...
    private function normalize(array $data): array
    {
        ...
        if (!preg_match('/^[A-Z0-9][A-Z0-9._-]{1,63}$/', $code)) {
            throw new \InvalidArgumentException('supplier code must be 2-64 chars and use letters, numbers, dot, underscore, or dash');
        }
