...
final class PdoCustomerRepository implements CustomerRepository
{
    ...
    {
        $statement = $this->pdo->prepare(
            'INSERT INTO customers (code, name, contact_name, phone, is_active, created_at)
        ...
        return $this->find((int) $this->pdo->lastInsertId()) ?? throw new \RuntimeException('customer not found');
    }
    ...
    public function update(int $id, array $data): array
    {
        ...
        return $this->find($id) ?? throw new \RuntimeException('customer not found');
    }
