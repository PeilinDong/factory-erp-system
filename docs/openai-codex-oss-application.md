...
The project is still early alpha. The most important missing workflows are richer work order status control, purchase workflow audit trail, Excel import/export, cost reporting, operation audit logs, data-scope permissions, installer flow, and production hardening.
