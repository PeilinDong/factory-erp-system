...
- Purchase order foundation with full and partial purchase receipt into inventory.
...
3. Add purchase workflow audit trail and finer-grained permission policy.
